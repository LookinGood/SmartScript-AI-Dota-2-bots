...
function GetDesire()
    ...
    if not npcBot:IsAlive() or not utility.CanMove(npcBot) or botLevel >= 30 or HealthPercentage < 0.5 or
        (#neutralCreeps == 0) or (#enemyHeroes > 0) or npcBot:IsChanneling() or
        botMode == BOT_MODE_ATTACK or botMode == BOT_MODE_RETREAT or
        botMode == BOT_MODE_PUSH_TOWER_TOP or botMode == BOT_MODE_PUSH_TOWER_MID or botMode == BOT_MODE_PUSH_TOWER_BOT or
        botMode == BOT_MODE_SECRET_SHOP or botMode == BOT_MODE_SIDE_SHOP
    then
